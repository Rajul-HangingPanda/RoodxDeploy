...
// Pages
import ForgotEmailForm from '@/components/auth/password/ForgotEmailForm';
import ForgotCodeForm from '@/components/auth/password/ForgotCodeForm';
import ForgotResetForm from '@/components/auth/password/ForgotResetForm';
