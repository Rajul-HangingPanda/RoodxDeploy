...
// Modules
import PolicyPrivacy from '@/components/auth/PolicyPrivacy';
  ...
  return (
    <>
      ...
      <div className="relative text-sm text-center after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
        <span className="relative z-10 px-2 text-roodx-headingText text-muted-foreground">{t('OrContinueWith')}</span>
      </div>
